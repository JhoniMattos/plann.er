...
export function CreateTripPage() {
  ...
  const [eventStartAnEndDates, setEventStartAndEndDates] = useState<DateRange | undefined>()
  ...
  async function createTrip(event: FormEvent<HTMLFormElement>) {
    ...
    console.log(eventStartAnEndDates)
    ...
    if (!eventStartAnEndDates?.from || !eventStartAnEndDates?.to) {
      return 
    }
